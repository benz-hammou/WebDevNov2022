...
var middleStudent = students.slice(students.length/2-1, students.length/2+1)
...
var firstAge = ages.slice(ages.length/2-1, ages.length/2+1)
console.log(firstAge); 
...
var arrayFromString = stringToAarray.split()
...
var arrayFromNames = names.split(' ')
...
var netSalary = brutoSalary - brutoSalary*20/100
